                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3 d-flex align-items-center">
                                                <label for="fullName" class="form-label me-3" style="min-width: 120px;">Full Name</label>
                                                <input type="text" id="fullName" class="form-control" value="{{$userData->first_name}} {{$userData->last_name}}" readonly>
                                            </div>
                
                                            <div class="mb-3 d-flex align-items-center">
                                                <label for="userId" class="form-label me-3" style="min-width: 120px;">User ID</label>
                                                <input type="text" id="userId" class="form-control" value="{{$userData->User_Email}}" readonly>
                                            </div>
                
                                            <div class="mb-3 d-flex align-items-center">
                                                <label for="contactNumber" class="form-label me-3" style="min-width: 120px;">Contact Number</label>
                                                <input type="text" id="contactNumber" class="form-control" value="{{$userData->Reg_Mobile}}" readonly>
                                            </div>
                
                                            <div class="mb-3 d-flex align-items-center">
                                                <label for="email" class="form-label me-3" style="min-width: 120px;">Email ID</label>
                                            ...
                                            <div class="mb-3 d-flex align-items-center">
                                                <label for="email" class="form-label me-3" style="min-width: 120px;">Active COD Cycle</label>
                                                <input type="text" id="email" class="form-control" value="{{$userData->Cod_Rem}}" readonly>
                                            </div>

                                            <div class="mb-3 d-flex align-items-center">
                                                <label for="email" class="form-label me-3" style="min-width: 120px;">Billing Type</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3 d-flex align-items-center">
                                                <label for="salesManagerName" class="form-label me-3" style="min-width: 140px;">Sales Manager Name</label>
                                                <input type="text" id="salesManagerName" class="form-control" value="{{$userData->Client_poc}}" readonly>
                                            </div>
                
                                            <div class="mb-3 d-flex align-items-center">
                                                <label for="salesManagerNumber" class="form-label me-3" style="min-width: 140px;">Sales Manager Number</label>
                                                <input type="text" id="salesManagerNumber" class="form-control" value="{{$userData->Poc_Mobile}}" readonly>
                                            </div>
                
                                            <div class="mb-3 d-flex align-items-center">
                                                <label for="keyAccountManager" class="form-label me-3" style="min-width: 140px;">Sales Manager Email</label>
                                                <input type="text" id="keyAccountManager" class="form-control" value="{{$userData->Poc_Email}}" readonly>
                                            </div>

                                            <div class="mb-3 d-flex align-items-center">
                                                <label for="keyAccountManager" class="form-label me-3" style="min-width: 140px;">Key Account Manager</label>
                                                <input type="text" id="keyAccountManager" class="form-control" value="{{$userData->Bd_Name}}" readonly>
                                            </div>

                                            <div class="mb-3 d-flex align-items-center">
                                                <label for="keyAccountManager" class="form-label me-3" style="min-width: 140px;">Key Account Manager Number</label>
                                                <input type="text" id="keyAccountManager" class="form-control" value="{{$userData->Bd_Mobile}}" readonly>
                                            </div>

                                            <div class="mb-3 d-flex align-items-center">
                                                <label for="keyAccountManager" class="form-label me-3" style="min-width: 140px;">Key Account Manager Email Id</label>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-12 d-flex align-items-center">
                                                <label for="email" class="form-label me-12" style="min-width: 100px;">Location</label>
