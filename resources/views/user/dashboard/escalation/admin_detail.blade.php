                            ...
                            <div class="card-body">
                                ...
                                <div class="container mt-4">
                                    ...
                                    <div class="support-header mb-4">
                                        <div>
                                            <a href="{{ route('user.escalations') }}"
                                                class="btn btn-primary mr-1 go_forbtn float-right"
                                                style="color:white;border-radius: 5px;padding: 0.3rem 0.8rem !important;"
                                                data-toggle="tooltip" data-placement="top" title="Go Back" type="submit"><i
                                                    class="fa-sharp fa fa-arrow-left"></i></a>
                                        </div>
                                        <div>
                                            <span class="ticket-id"><b>{{ mention_client_name($ticketDetails) }}</b></span>
                                            ...
                                            <div class="status-tag">
                                                ...
                                                <span class="last-update">Last Update:
                                                    {{ \Carbon\Carbon::parse($ticketDetails->updated_at)->format('d-m-Y H:i:s') }}</span>
                                            </div>
                                        </div>
                                        <div>
                                            @if ($ticketDetails->status == '0')
                                                <button class="btn btn-outline-success" id="resolved"
                                                    data-ticket-id="{{ $ticketDetails->ticket_id }}">Mark as
                                                    Resolved</button>
                                            @else
                                            @endif
                                        </div>
                                            ...
                                            <div class="chat-box">
                                                @foreach ($ticketHistory as $history)
                                                        ...
                                                        <div class="chat-message d-flex align-items-start">
                                                            <div class="message-avatar">
                                                                <div class="avatar-circle">
                                                                    @php
                                                                        echo mention_client_initials($ticketDetails);
                                                                    @endphp</div>
                                                            </div>
                                                            ...
                                                            <small
                                                                class="text-muted d-block mt-2 ml-2">{{ \Carbon\Carbon::parse($history->created_at)->format('d-m-Y H:i:s') }}</small>
                                                        </div>
                                                    @endif
                                                    ...
                                                    @if ($history->usertype == 'admin')
                                                        <div
                                                            class="chat-message d-flex align-items-start justify-content-end text-right">
            ...
            $('body').on('submit', '#addForm', function(e) {
                ...
                Swal.fire({
                    ...
                    customClass: {
                        ...
                        htmlContainer: 'swal-custom-message',
                    }
                }).then((result) => {
