                ...
                <div class="card h-100">    
                            ...
                            <div class="card">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <h4 style="color: #ffcc00;">{{$summary['status']}}</h4>
                                    </div>
                                    <div>
                                        <span style="color: black;">Last Updated on {{ now()->format('d M Y, l') }}</span>
                                    </div>
                                </div>
                            </div>                            
                        </div>
                    ...
                    <div class="card-header">
                        <h3 style="font-size: 14px; color: black;">
                            <img src="{{asset('img/track.png')}}" alt="shadow" class="img-fluid" style="width: 20%; height: 45px;">
                            &nbsp;&nbsp;&nbsp;&nbsp;Real Time Tracking
                        </h3>
                                            ...
                                            <div class="progres-bar">
                                              ...
                                              <div class="progress-container">
                                                <div class="progress-date">
                                                    <h6>{{ \Carbon\Carbon::parse($logs['eventTime'])->format('M d, Y') }}</h6>
                                                  <small>{{ \Carbon\Carbon::parse($logs['eventTime'])->format('D, H:i') }}</small>
                                                </div>
                                                <span class="active"></span>
                                                <div class="progress-step">
                                                  <h6>{{$logs['eventCode']}}</h6>

                                                  @if(!empty($logs['location']) && is_array($logs['location']))
                                                  @foreach ($logs['location'] as $item)
                                                      <small><img src="{{ asset('img/MapPin.png') }}" alt="" style="height: 20px;"></small>
                                                  @endforeach
                                              @else
                                                 -
                                              @endif
