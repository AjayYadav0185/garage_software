                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <h4 class="mb-0">{{ translate('Debit Note') }}</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class=" text-right " style="margin-right:2% ;">
                                    ...
                                    @if (get_role(Auth::user()->usertype) == 2)
                                        <a href="#" class="btn btn-outline-primary"
                                            onclick="openBulkUploadModal('debit')"><i class="fa fa-cloud-upload"
                                                aria-hidden="true"></i>
                                           {{ translate('Bulk Upload') }}</a>
                                    @endif

                                    <a href="#" class="btn btn-outline-primary" onclick="myFunction()"><i
                                            class="fa fa-filter" aria-hidden="true"></i>&nbsp;{{ translate('Filter') }}&nbsp;</i></a>
                                    {{--
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#Credit_table').DataTable({
                ...
                language: {
                    search: "_INPUT_",
                    searchPlaceholder: "Search By Debit Id"
                },
                dom: 'ftlip',
                ajax: {
                    url: "{{ route('user.debitNote') }}",
                    type: 'GET',
                    datatype: "json",
                    data: function(d) {
