...
@section('user-contant')
                            ...
                            <div class="card-body px-4 py-4">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-4 align-items-center mb-3" style=" height: 36px; display: flex;">
                                        ...
                                        <a href="javascript:void(0);" class="btn btn-info btn-primary ml-md-3"
                                            style=" display: block;" id="serviceable_report_2">
                                            Download All
                                        </a>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-4">
                                        <a class="btn btn-primary" onclick="calculateraterefresh()"
                                            style="height: 35px; margin-top: 25px;"><i class="fa fa-rss-square" aria-hidden="true"></i>  Get
                                            Data</a>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
                ...
                if (pincode.length == 6) {
                    ...
                    $.ajax({
                        ...
                        success: function (data, status, xhr) {
                            const filename = xhr.getResponseHeader('Content-Disposition')?.split('filename=')[1] || 'serviceable-pincodes.xlsx';
        ...
        $(document).on('click', '#serviceable_report_2', function () {
            $('.loader').show();
            $('#serviceable_report').prop('disabled', true).text('Downloading...');
            $.ajax({
                url: "{{ route('user.AllDownloadPincodes') }}",
                type: "GET",
                xhrFields: {
                    responseType: 'blob'
                },
                success: function (data, status, xhr) {
                    const filename = xhr.getResponseHeader('Content-Disposition')?.split(
                        'filename=')[1] || 'All-serviceable-pincodes.xlsx';
