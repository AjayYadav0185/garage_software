                    ...
                    <div class="col-12 col-sm-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <iframe src="{{ asset('packing_guidelines/PackagingGuidlines.pdf') }}" width="100%"
                                    height="600px" style="border:1px solid #ccc;"></iframe>
                                <div class="d-flex justify-content-center align-items-center gap-4 mt-4 flex-wrap">
                                    <!-- Download Button -->
                                    <a href="{{ asset('packing_guidelines/PackagingGuidlines.pdf') }}"
                                        class="btn btn-primary" download>
                                        <i class="fa fa-download"></i> Download Packing Guidelines
                                    </a>
