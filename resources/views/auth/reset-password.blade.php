...
<head>
    ...
    <title>Password Reset - Garage Management</title>
    ...
    <div class="login-container">
        ...
        <form method="POST" action="{{ route('password.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" class="form-input" required autofocus value="{{ old('email', $request->email) }}" autocomplete="username">
            ...
            <!-- Confirm Password -->
            <div class="form-group">
                <label for="password_confirmation" class="form-input-label">Confirm Password</label>
