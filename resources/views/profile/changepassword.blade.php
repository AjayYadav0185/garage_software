                            ...
                            <div class="tab-pane fade show active" id="home3" role="tabpanel"
                                ...
                                <div class="card col-md-10 ">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" id="changepasswordform" action="{{route('profile.verify-change-password')}}">

                                            {!! csrf_field() !!}
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label>{{ translate('Old Password') }}<span class="text-danger">*</span></label>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <span id="password-hint" class="text-info" style="font-size:13px">
                                                       {{ translate(' Password should contains numbers, letters, and special characters.') }}
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="row">
