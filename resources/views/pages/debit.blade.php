...
<head>
    <meta charset="UTF-8">
    <title>{{ translate('Debit Invoice') }}</title>
    <style>
        body {
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                ...
                <td style="text-align: left; white-space: nowrap;">
                    {{ translate('DN Against Invoice No:') }} {{ $data->debit_id }}
                </td>
            </tr>
            <tr>
                <td style="text-align: left; white-space: nowrap;">
                    {{ translate('DN Against Invoice Date :') }}
            ...
            <tr>
                ...
                <td style="vertical-align: top;">
                    <span style="display: inline-block; width: 100px;">{{ translate('DN No :') }}</span>
                    {{ $data->debit_id }}<br>
                    <div style="height: 1px; background-color: #000; margin: 4px 0;"></div>
                    <span style="display: inline-block; width: 100px;">{{ translate('DN Issued Date :') }}</span>
