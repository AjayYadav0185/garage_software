...
$(function () {
    ...
    var toggle_sidebar_mini = function (mini) {
        ...
        if (!mini) {
            ...
            $(".main-sidebar .sidebar-menu > li > ul .dropdown-title").add();
            $(".main-sidebar .sidebar-menu > li > a").addAttr("data-toggle");
            $(".main-sidebar .sidebar-menu > li > a").addAttr(
                "data-original-title",
            );
            $(".main-sidebar .sidebar-menu > li > a").addAttr("title");
        } else {
            // Show/hide logos
            $(".logo1head").show();
            $(".logo2head").hide();
